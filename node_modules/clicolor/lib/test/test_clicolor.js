...
describe("clicolor", () => {
    ...
    it("status line", () => {
        const s = new __1.StatusUpdater({ width: 16, frequency: 100 });
    ...
    it("padLeft", () => {
        ...
        cli.padLeft(20, cli.color("red", "hello"), "copter").toString().should.eql("         \u001b[38;5;9mhello\u001b[39mcopter");
    });
    it("padRight", () => {
        const cli = __1.clicolor();
        ...
        cli.padRight(20, cli.color("red", "hello"), "copter").toString().should.eql("\u001b[38;5;9mhello\u001b[39mcopter         ");
    });
    it("underline", () => {
        const cli = __1.clicolor();
    ...
    it("nested spans", () => {
        ...
        cli.backgroundColor("red", "what? ", inner2, " ok!").toString().should.eql("\u001b[48;5;9mwhat? " +
    ...
    it("format", () => {
        ...
        cli.format(formats, "ok, <blue>stop <red10>ack</red10></blue>!").toString().should.eql("ok, \u001b[38;5;12mstop \u001b[48;5;9m       ack\u001b[49m\u001b[39m!");
        cli.format(formats, "<brown>wut?</brown><blue>ok</blue>").toString().should.eql("\u001b[38;5;124mwut?      \u001b[38;5;12mok\u001b[39m");
        cli.format(formats, "<info>Downloading launch codes (<number>23</number>)</info>").toString().should.eql("\u001b[38;5;14mDownloading launch codes (\u001b[38;5;12m  23\u001b[38;5;14m)\u001b[39m");
        cli.format(formats, "\\<blue>ok").toString().should.eql("\\<blue>ok");
    });
});
//# sourceMappingURL=test_clicolor.js.map