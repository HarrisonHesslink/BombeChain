"use strict";
var xterm256 = require("../antsy/xterm256");
require("should");
describe("xterm256", function () {
    describe("finds the nearest", function () {
        it("color cube", function () {
        ...
        it("color, in general", function () {
            xterm256.nearest_color(0, 0, 0).should.eql(0);
            xterm256.nearest_color(12, 12, 12).should.eql(232);
            xterm256.nearest_color(127, 127, 0).should.eql(3);
            xterm256.nearest_color(133, 133, 0).should.eql(100);
            xterm256.nearest_color(250, 40, 100).should.eql(197);
            xterm256.nearest_color(217, 217, 217).should.eql(253);
            xterm256.nearest_color(216, 216, 216).should.eql(188);
        });
        it("color, from hex", function () {
            xterm256.color_from_hex("000").should.eql(0);
            xterm256.color_from_hex("000000").should.eql(0);
            xterm256.color_from_hex("ccc").should.eql(252);
            xterm256.color_from_hex("0c0c0c").should.eql(232);
            xterm256.color_from_hex("7f7f00").should.eql(3);
            xterm256.color_from_hex("858500").should.eql(100);
            xterm256.color_from_hex("fa2864").should.eql(197);
            xterm256.color_from_hex("d9d9d9").should.eql(253);
            xterm256.color_from_hex("d8d8d8").should.eql(188);
        });
